...
import com.example.wdks.newwdksapp.adapter.Page39OROneListViewAdapter;
...
* 订单记录管理页面一
* */
public class Page39OrderRecordOneFragment extends Fragment implements View.OnClickListener,
        Page39OROneListViewAdapter.MyClickListener {

    private View view, mEmpty;
    private List<OrderRecord> mData;
    private ListView mListView;
    private Page39OROneListViewAdapter mAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (view == null) {
            view = inflater.inflate(R.layout.page39_order_record_one, container, false);
            initView();
        }
        return view;
    }
    ...
    private void initView() {
        ...
        mListView = (ListView) view.findViewById(R.id.ks_page39_one_listView);   //主要内容
        mAdapter = new Page39OROneListViewAdapter(getActivity(), mData);
        mListView.setAdapter(mAdapter);
        mEmpty = view.findViewById(R.id.ks_page39_one_empty);   //无订单记录的提示
