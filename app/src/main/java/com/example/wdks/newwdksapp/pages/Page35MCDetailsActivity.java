...
import com.example.wdks.newwdksapp.adapter.Page35MCDetailsViewPagerAdapter;
...
* 我的收藏的详情页面
* */
public class Page35MCDetailsActivity extends AppCompatActivity implements View.OnClickListener {

    private View mBack, mCollection;
    private ImageView mImageView1, mLeftArrow, mRightArrow;
    private boolean TAG = true;
    private ViewPager mViewPager;
    private Page35MCDetailsViewPagerAdapter mViewPagerAdapter;
    private List<Fragment> mFragments;
    private Page35MCDetailsOneFragment mFragmentOne;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.page35_mc_details);
        initData();
        initView();
    }
    ...
    private void initView() {
        mBack = findViewById(R.id.ks_page35_back);   //返回按钮
        mCollection = findViewById(R.id.ks_page35_collect);   //收藏按钮
        mImageView1 = (ImageView) findViewById(R.id.ks_page35_iv1);   //收藏图标

        mLeftArrow = (ImageView) findViewById(R.id.ks_page35_leftArrow);   //上一题
        mRightArrow = (ImageView) findViewById(R.id.ks_page35_rightArrow);   //下一题
        mViewPager = (ViewPager) findViewById(R.id.ks_page35_viewPager);   //答题区（主要内容）

        FragmentManager manager = getSupportFragmentManager();
        mFragments = new ArrayList<Fragment>();
        for (int i = 0; i < 3; i++) {
            mFragmentOne = Page35MCDetailsOneFragment.newInstance(radio_questionType, radio_questionNum, radio_questionAll,
        ...
        Page35MCDetailsViewPagerAdapter mViewPagerAdapter = new Page35MCDetailsViewPagerAdapter(manager, this, mFragments);
    ...
    //试视图操作
    private void init() {
        mImageView1.setImageResource(R.drawable.ico_collect_on);   //默认选中（收藏）
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.ks_page35_back:
                finish();
                break;
            case R.id.ks_page35_collect:
                if (TAG) {
                ...
                break;
            case R.id.ks_page35_leftArrow:
                Toast.makeText(this, "上一题", Toast.LENGTH_SHORT).show();
                break;
            case R.id.ks_page35_rightArrow:
