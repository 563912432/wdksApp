...
* 我的错题的详情页面的单选页面
* */
public class Page36MWDetailsTestOneFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.page36_mw_details_test_one, container, false);
            initView();
        }
        return view;
    }
    ...
    private void initView() {
        mTextView1 = (TextView) view.findViewById(R.id.ks_page36_mw_details_test_one_tv1);   //题目类型
        mTextView2 = (TextView) view.findViewById(R.id.ks_page36_mw_details_test_one_tv2);   //题目总数
        mTextView3 = (TextView) view.findViewById(R.id.ks_page36_mw_details_test_one_tv3);   //题号
        mTextView4 = (TextView) view.findViewById(R.id.ks_page36_mw_details_test_one_tv4);   //题干
        mRadioGroup = (RadioGroup) view.findViewById(R.id.ks_page36_mw_details_test_one_radioGroup);   //radioGroup
        mRB1 = (RadioButton) view.findViewById(R.id.ks_page36_mw_details_test_one_rb1);   //选项A
        mRB2 = (RadioButton) view.findViewById(R.id.ks_page36_mw_details_test_one_rb2);   //选项B
        mRB3 = (RadioButton) view.findViewById(R.id.ks_page36_mw_details_test_one_rb3);   //选项C
        mRB4 = (RadioButton) view.findViewById(R.id.ks_page36_mw_details_test_one_rb4);   //选项D
        mTextView5 = (TextView) view.findViewById(R.id.ks_page36_mw_details_test_one_tv5);   //正确答案
        mTextView6 = (TextView) view.findViewById(R.id.ks_page36_mw_details_test_one_tv6);   //你的答案
        mTextView7 = (TextView) view.findViewById(R.id.ks_page36_mw_details_test_one_tv7);   //答案解析
        mTextView8 = (TextView) view.findViewById(R.id.ks_page36_mw_details_test_one_tv8);   //编辑笔记

        mWatch = (TextView) view.findViewById(R.id.ks_page36_mw_details_test_one_watch);   //查看解析
        mResolve = view.findViewById(R.id.ks_page36_mw_details_test_one_resolve);   //答案解析的内容
        mEditText1 = (EditText) view.findViewById(R.id.ks_page36_mw_details_test_one_et);   //提问内容
        mButton1 = (Button) view.findViewById(R.id.ks_page36_mw_details_test_one_btn1);   //提交提问
    ...
    private void init() {
        ...
        mRadioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup group, int checkedId) {
                switch (checkedId) {
                    case R.id.ks_page36_mw_details_test_one_rb1:
                        s = "A";
                        break;
                    case R.id.ks_page36_mw_details_test_one_rb2:
                        s = "B";
                        break;
                    case R.id.ks_page36_mw_details_test_one_rb3:
                        s = "C";
                        break;
                    case R.id.ks_page36_mw_details_test_one_rb4:
                        s = "D";
                        break;
                }
            }
    ...
    //自己定义fragment的构造方法
    public static Page36MWDetailsTestOneFragment newInstance(List<String> questionType, List<String> questionNum, List<String> questionAll,
        ...
        Page36MWDetailsTestOneFragment page36TestOneFragment = new Page36MWDetailsTestOneFragment();
        page36TestOneFragment.setArguments(bundle);

        return page36TestOneFragment;
    }

    @Override
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.ks_page36_mw_details_test_one_tv8:
                Toast.makeText(getActivity(), "编辑笔记" + flag, Toast.LENGTH_SHORT).show();
                break;
            case R.id.ks_page36_mw_details_test_one_watch:
                ...
                break;
            case R.id.ks_page36_mw_details_test_one_btn1:
