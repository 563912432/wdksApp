...
public class Page39OROneListViewAdapter extends BaseAdapter {
    private Context context;
    private List<OrderRecord> mData;
    private MyClickListener mListener;

    public Page39OROneListViewAdapter(Context context, List<OrderRecord> mData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.page39_order_record_one_listview, null);
            viewHolder.mOrderNum = (TextView) convertView.findViewById(R.id.ks_page39_one_listView_tv1);   //订单号
            viewHolder.mOrderState = (TextView) convertView.findViewById(R.id.ks_page39_one_listView_tv2);   //订单状态
            viewHolder.mImageView1 = (ImageView) convertView.findViewById(R.id.ks_page39_one_listView_iv1);   //图片
            viewHolder.mTitle = (TextView) convertView.findViewById(R.id.ks_page39_one_listView_tv3);   //标题
            viewHolder.mPrice = (TextView) convertView.findViewById(R.id.ks_page39_one_listView_tv4);   //单价
            viewHolder.mNumbers = (TextView) convertView.findViewById(R.id.ks_page39_one_listView_tv5);   //数量
            viewHolder.mContent = (TextView) convertView.findViewById(R.id.ks_page39_one_listView_tv6);   //备注
            viewHolder.mAddAll = (TextView) convertView.findViewById(R.id.ks_page39_one_listView_tv7);   //总价
            viewHolder.mFreight = (TextView) convertView.findViewById(R.id.ks_page39_one_listView_tv8);   //运费
            viewHolder.mPayOff = (TextView) convertView.findViewById(R.id.ks_page39_one_listView_tv9);   //付款
            viewHolder.mDelete = (TextView) convertView.findViewById(R.id.ks_page39_one_listView_tv10);   //删除订单
            viewHolder.mContact = (TextView) convertView.findViewById(R.id.ks_page39_one_listView_tv11);   //联系客服
    ...
    private View.OnClickListener mOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (mListener != null) {
                ...
                switch (v.getId()) {
                    case R.id.ks_page39_one_listView_tv9:   //付款
                        mListener.onPayOff(Page39OROneListViewAdapter.this, v, position);
                        break;
                    case R.id.ks_page39_one_listView_tv10:   //删除订单
                        mListener.onDelete(Page39OROneListViewAdapter.this, v, position);
                        break;
                    case R.id.ks_page39_one_listView_tv11:   //联系客服
                        mListener.onContact(Page39OROneListViewAdapter.this, v, position);
                        break;
                }
            }
        }
