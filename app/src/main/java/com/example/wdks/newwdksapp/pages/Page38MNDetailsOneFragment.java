...
* 预测试卷单选页面
* */
public class Page38MNDetailsOneFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.page38_mn_details_one, container, false);
            initView();
        }
        return view;
    }
    ...
    private void initView() {
        mTextView1 = (TextView) view.findViewById(R.id.ks_page38_mn_details_one_tv1);   //题目类型
        mTextView2 = (TextView) view.findViewById(R.id.ks_page38_mn_details_one_tv2);   //题目总数
        mTextView3 = (TextView) view.findViewById(R.id.ks_page38_mn_details_one_tv3);   //题号
        mTextView4 = (TextView) view.findViewById(R.id.ks_page38_mn_details_one_tv4);   //题干
        mRadioGroup = (RadioGroup) view.findViewById(R.id.ks_page38_mn_details_one_radioGroup);   //radioGroup
        mRB1 = (RadioButton) view.findViewById(R.id.ks_page38_mn_details_one_rb1);   //选项A
        mRB2 = (RadioButton) view.findViewById(R.id.ks_page38_mn_details_one_rb2);   //选项B
        mRB3 = (RadioButton) view.findViewById(R.id.ks_page38_mn_details_one_rb3);   //选项C
        mRB4 = (RadioButton) view.findViewById(R.id.ks_page38_mn_details_one_rb4);   //选项D
        mTextView5 = (TextView) view.findViewById(R.id.ks_page38_mn_details_one_tv5);   //正确答案
        mTextView6 = (TextView) view.findViewById(R.id.ks_page38_mn_details_one_tv6);   //你的答案
        mTextView7 = (TextView) view.findViewById(R.id.ks_page38_mn_details_one_tv7);   //答案解析
        mTextView8 = (TextView) view.findViewById(R.id.ks_page38_mn_details_one_tv8);   //我的笔记显示内容
        mTextView9 = (TextView) view.findViewById(R.id.ks_page38_mn_details_one_tv9);   //编辑笔记

        //mWatch = (TextView) view.findViewById(R.id.ks_page38_mn_details_one_watch);   //查看解析
        mResolve = view.findViewById(R.id.ks_page38_mn_details_one_resolve);   //答案解析的内容
    ...
    private void init() {
        ...
        mTextView8.setText("我的笔记的详细内容详细内容详细内容详细内容详细内容详细内容详细内容详细内容详细内容详细内容详细内容");
    ...
    //自己定义fragment的构造方法
    public static Page38MNDetailsOneFragment newInstance(List<String> questionType, List<String> questionNum, List<String> questionAll,
        ...
        Page38MNDetailsOneFragment page38MNDetailsOneFragment = new Page38MNDetailsOneFragment();
        page38MNDetailsOneFragment.setArguments(bundle);

        return page38MNDetailsOneFragment;
    }

    @Override
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.ks_page38_mn_details_one_tv9:
