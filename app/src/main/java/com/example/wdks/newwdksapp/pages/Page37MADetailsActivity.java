...
import com.example.wdks.newwdksapp.adapter.Page37MADetailsViewPagerAdapter;
...
* 我的答疑的详情页面
* */
public class Page37MADetailsActivity extends AppCompatActivity implements View.OnClickListener {

    private View mBack, mCollection;
    private ImageView mImageView1, mLeftArrow, mRightArrow;
    private boolean TAG = true;
    private ViewPager mViewPager;
    private Page37MADetailsViewPagerAdapter mViewPagerAdapter;
    private List<Fragment> mFragments;
    private Page37MADetailsOneFragment mFragmentOne;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.page37_ma_details);
        initData();
        initView();
    }
    ...
    private void initView() {
        mBack = findViewById(R.id.ks_page37_back);   //返回按钮
        mCollection = findViewById(R.id.ks_page37_collect);   //收藏按钮
        mImageView1 = (ImageView) findViewById(R.id.ks_page37_iv1);   //收藏图标
        mLeftArrow = (ImageView) findViewById(R.id.ks_page37_leftArrow);   //上一题
        mRightArrow = (ImageView) findViewById(R.id.ks_page37_rightArrow);   //下一题

        mViewPager = (ViewPager) findViewById(R.id.ks_page37_viewPager);   //题目的展示区域
        FragmentManager manager = getSupportFragmentManager();

        mFragments = new ArrayList<Fragment>();
        for (int i = 0; i < 3; i++) {
            mFragmentOne = Page37MADetailsOneFragment.newInstance(radio_questionType, radio_questionNum, radio_questionAll,
        ...
        mViewPagerAdapter = new Page37MADetailsViewPagerAdapter(manager, this, mFragments);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.ks_page37_back:
                finish();
                break;
            case R.id.ks_page37_collect:
                if (TAG) {
                ...
                break;
            case R.id.ks_page37_leftArrow:
                Toast.makeText(this, "上一题", Toast.LENGTH_SHORT).show();
                break;
            case R.id.ks_page37_rightArrow:
