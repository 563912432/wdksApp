...
public class MyLooperTextView extends FrameLayout {
    ...
    public MyLooperTextView(Context context) {
        super(context);
        initTipFrame();
        initAnimation();
    }

    public MyLooperTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initTipFrame();
        initAnimation();
    }

    public MyLooperTextView(Context context, AttributeSet attrs, int defStyleAttr) {
