...
import com.example.wdks.newwdksapp.adapter.Page37MADetailsOneListViewAdapter;
...
* 我的答疑的详情页面的单选页面
* */
public class Page37MADetailsOneFragment extends Fragment implements View.OnClickListener {
    ...
    private Page37MADetailsOneListViewAdapter mListViewAdapter;
    ...
    private void initData() {
        ...
        if (bundle != null) {
            ...
            mData = new ArrayList<MyAsk>();
            mData.add(new MyAsk("考试中理论题占多少分，电算化有什么好的学习方法吗？", "2016-10-26",
                    "你好，理论题占40分，学电算化一般只要掌握好操作就可以了", "2016-10-31"));
        }
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.page37_ma_details_one, container, false);
            initView();
        }
        return view;
    }
    ...
    private void initView() {
        mTextView1 = (TextView) view.findViewById(R.id.ks_page37_ma_details_one_tv1);   //题目类型
        mTextView2 = (TextView) view.findViewById(R.id.ks_page37_ma_details_one_tv2);   //题目总数
        mTextView3 = (TextView) view.findViewById(R.id.ks_page37_ma_details_one_tv3);   //题号
        mTextView4 = (TextView) view.findViewById(R.id.ks_page37_ma_details_one_tv4);   //题干
        mRadioGroup = (RadioGroup) view.findViewById(R.id.ks_page37_ma_details_one_radioGroup);   //radioGroup
        mRB1 = (RadioButton) view.findViewById(R.id.ks_page37_ma_details_one_rb1);   //选项A
        mRB2 = (RadioButton) view.findViewById(R.id.ks_page37_ma_details_one_rb2);   //选项B
        mRB3 = (RadioButton) view.findViewById(R.id.ks_page37_ma_details_one_rb3);   //选项C
        mRB4 = (RadioButton) view.findViewById(R.id.ks_page37_ma_details_one_rb4);   //选项D
        mTextView5 = (TextView) view.findViewById(R.id.ks_page37_ma_details_one_tv5);   //正确答案
        mTextView6 = (TextView) view.findViewById(R.id.ks_page37_ma_details_one_tv6);   //你的答案
        mTextView7 = (TextView) view.findViewById(R.id.ks_page37_ma_details_one_tv7);   //答案解析
        mTextView8 = (TextView) view.findViewById(R.id.ks_page37_ma_details_one_tv8);   //编辑笔记

        mListView = (ListView) view.findViewById(R.id.ks_page37_ma_details_one_listView);   //我的答疑的内容展示
        mListViewAdapter = new Page37MADetailsOneListViewAdapter(getActivity(), mData);
        mListView.setAdapter(mListViewAdapter);

        //mWatch = (TextView) view.findViewById(R.id.ks_page37_ma_details_one_watch);   //查看解析
        mResolve = view.findViewById(R.id.ks_page37_ma_details_one_resolve);   //答案解析的内容
    ...
    //自己定义fragment的构造方法
    public static Page37MADetailsOneFragment newInstance(List<String> questionType, List<String> questionNum, List<String> questionAll,
        ...
        Page37MADetailsOneFragment page37MADetailsOneFragment = new Page37MADetailsOneFragment();
        page37MADetailsOneFragment.setArguments(bundle);

        return page37MADetailsOneFragment;
    }

    @Override
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.ks_page37_ma_details_one_tv8:
