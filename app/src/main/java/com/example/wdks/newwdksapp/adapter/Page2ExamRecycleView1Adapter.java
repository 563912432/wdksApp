...
public class Page2ExamRecycleView1Adapter extends RecyclerView.Adapter<Page2ExamRecycleView1Adapter.ViewHolder> {
    ...
    public Page2ExamRecycleView1Adapter(Context context, List<CoursesData> data) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int position) {
        View view = mInflater.inflate(R.layout.page2_shop_exam_recycleview1, parent, false);
        ViewHolder viewHolder = new ViewHolder(view);
        viewHolder.mTextView1 = (TextView) view.findViewById(R.id.ks_page2_exam_recycleView1_tv1);
        return viewHolder;
    }
